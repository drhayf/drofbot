...
import { lookupContextTokens } from "../../brain/agent-runner/context.js";
import { DEFAULT_CONTEXT_TOKENS } from "../../brain/agent-runner/defaults.js";
...
import { type SessionEntry, updateSessionStore } from "../../shared/config/sessions.js";
import { applyModelOverrideToSessionEntry } from "../../shared/sessions/model-overrides.js";
import { resolveThreadParentSessionKey } from "../../shared/sessions/session-key-utils.js";
...
export async function createModelSelectionState(params: {
  ...
  if (sessionEntry && sessionStore && sessionKey && sessionEntry.authProfileOverride) {
    const { ensureAuthProfileStore } = await import("../../brain/agent-runner/auth-profiles.js");
