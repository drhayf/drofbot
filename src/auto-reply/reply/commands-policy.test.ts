...
vi.mock("../../shared/config/config.js", async () => {
  const actual =
    await vi.importActual<typeof import("../../shared/config/config.js")>("../../shared/config/config.js");
  return {
    ...actual,
...
vi.mock("../../channels/shared/plugins/pairing.js", async () => {
  const actual = await vi.importActual<typeof import("../../channels/shared/plugins/pairing.js")>(
    "../../channels/shared/plugins/pairing.js",
  );
  return {
    ...actual,
...
vi.mock("../../brain/agent-runner/model-catalog.js", () => ({
