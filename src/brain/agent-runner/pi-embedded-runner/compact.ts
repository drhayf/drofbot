...
import { isSubagentSessionKey } from "../../../shared/routing/session-key.js";
...
import { flushCompactionMemory } from "../../memory/structured-memory-integration.js";
  ...
  try {
    ...
    try {
      ...
      try {
        ...
        // Flush compaction summary to structured memory (fire-and-forget).
        // Preserves key conversation context that would otherwise be lost.
        if (result.summary) {
          flushCompactionMemory(result.summary, {
            sessionId: params.sessionId,
            sessionKey: params.sessionKey,
            channel: params.messageChannel ?? params.messageProvider,
          }).catch(() => {
            // Non-fatal — structured memory is an enhancement layer
          });
        }
