...
export function createOpenClawCodingTools(options?: {
  ...
  // Pi SDK tool types don't structurally match AnyAgentTool; cross-library boundary cast.
  ...
  const tools: AnyAgentTool[] = [
    ...
    ...(sandboxRoot
      ? allowWorkspaceWrites
        ...
        : []
      : []),
    // Pi SDK tool factories return types that don't structurally match AnyAgentTool.
