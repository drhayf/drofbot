...
export async function ensureLoaded(
  ...
  // JSON file data is validated field-by-field above; cast back to typed form after migration.
  ...
  // After runtime validation/migration above, the records conform to CronJob.
