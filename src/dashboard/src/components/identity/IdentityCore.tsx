  ...
  return (
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <Card>
          <CardContent>
            <h3 className="text-sm font-medium text-ink-2 mb-4 uppercase tracking-wider">Birth Moment</h3>
        ...
        <Card>
          <CardContent>
             <h3 className="text-sm font-medium text-ink-2 mb-4 uppercase tracking-wider">Human Design</h3>
             {humanDesign ? (
        ...
        {cardology && (
          <Card>
            <CardContent>
               <h3 className="text-sm font-medium text-ink-2 mb-4 uppercase tracking-wider">Cardology</h3>
               <div className="flex items-center gap-4">
                 ...
                 <div>
                   ...
                   <span className="text-ink-1 font-medium">Ruler: {cardology.planetaryRuler}</span>
                 </div>
               </div>
            </CardContent>
          </Card>
