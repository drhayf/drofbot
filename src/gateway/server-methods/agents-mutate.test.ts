...
vi.mock("../../brain/agent-runner/workspace.js", async () => {
  const actual = await vi.importActual<typeof import("../../brain/agent-runner/workspace.js")>(
    "../../brain/agent-runner/workspace.js",
  );
  return {
    ...actual,
...
vi.mock("../../shared/config/sessions/paths.js", () => ({
