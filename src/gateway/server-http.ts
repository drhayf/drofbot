...
import { createDashboardApiHandler } from "../api/handler.js";
import { resolveAgentAvatar } from "../brain/agent-runner/identity-avatar.js";
import {
  A2UI_PATH,
  CANVAS_HOST_PATH,
  CANVAS_WS_PATH,
...
export function createGatewayHttpServer(opts: {
  ...
  openResponsesConfig?: import("../shared/config/types.gateway.js").GatewayHttpResponsesConfig;
  ...
  const dashboardApiHandler = createDashboardApiHandler();
  ...
  async function handleRequest(req: IncomingMessage, res: ServerResponse) {
    ...
    try {
      ...
      // Dashboard API handler (/api/* routes)
      if (await dashboardApiHandler(req, res)) {
        return;
      }
