...
import type { ChannelPlugin, ChannelOutboundAdapter } from "../channels/shared/plugins/types.js";
import type { AgentBinding } from "../shared/config/types.agents.js";
import type { HooksConfig } from "../shared/config/types.hooks.js";
import type { TailscaleWhoisIdentity } from "../infra/tailscale.js";
import type { PluginRegistry } from "../plugins/registry.js";
import { applyPluginAutoEnable } from "../shared/config/plugin-auto-enable.js";
import { setActivePluginRegistry } from "../plugins/runtime.js";
import { DEFAULT_ACCOUNT_ID } from "../shared/routing/session-key.js";
...
vi.mock("../agents/pi-model-discovery.js", async () => {
  const actual = await vi.importActual<typeof import("../brain/agent-runner/pi-model-discovery.js")>(
...
vi.mock("../config/sessions.js", async () => {
  const actual =
    await vi.importActual<typeof import("../shared/config/sessions.js")>("../config/sessions.js");
  return {
    ...actual,
...
vi.mock("../config/config.js", async () => {
  const actual = await vi.importActual<typeof import("../shared/config/config.js")>("../config/config.js");
...
vi.mock("../agents/pi-embedded.js", async () => {
  const actual = await vi.importActual<typeof import("../brain/agent-runner/pi-embedded.js")>(
...
vi.mock("../channels/web/index.js", async () => {
  const actual = await vi.importActual<typeof import("../channels/shared/web-shared/index.js")>(
