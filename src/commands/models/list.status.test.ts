...
vi.mock("../../brain/agent-runner/agent-paths.js", () => ({
  resolveOpenClawAgentDir: mocks.resolveOpenClawAgentDir,
}));

vi.mock("../../brain/agent-runner/agent-scope.js", () => ({
...
vi.mock("../../brain/agent-runner/auth-profiles.js", async (importOriginal) => {
  const actual = await importOriginal<typeof import("../../brain/agent-runner/auth-profiles.js")>();
  return {
    ...actual,
...
vi.mock("../../brain/agent-runner/model-auth.js", () => ({
