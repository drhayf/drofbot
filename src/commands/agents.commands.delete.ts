...
import { resolveAgentDir, resolveAgentWorkspaceDir } from "../brain/agent-runner/agent-scope.js";
import { writeConfigFile } from "../shared/config/config.js";
import { logConfigUpdated } from "../shared/config/logging.js";
import { resolveSessionTranscriptsDirForAgent } from "../shared/config/sessions.js";
import { DEFAULT_AGENT_ID, normalizeAgentId } from "../shared/routing/session-key.js";
