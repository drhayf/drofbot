...
vi.mock("../../../shared/routing/resolve-route.js", () => ({
  resolveAgentRoute: (...args: unknown[]) => resolveAgentRouteMock(...args),
}));

vi.mock("../../../brain/agent-runner/identity.js", async (importOriginal) => {
  const actual = await importOriginal<typeof import("../../../brain/agent-runner/identity.js")>();
  return {
    ...actual,
