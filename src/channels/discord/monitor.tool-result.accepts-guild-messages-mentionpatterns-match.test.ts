...
vi.mock("../../shared/config/sessions.js", async (importOriginal) => {
  const actual = await importOriginal<typeof import("../../shared/config/sessions.js")>();
  return {
    ...actual,
...
describe("discord tool result dispatch", () => {
  it(
    ...
    async () => {
      ...
      } as ReturnType<typeof import("../../shared/config/config.js").loadConfig>;
