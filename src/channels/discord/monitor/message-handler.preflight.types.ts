...
import type { ReplyToMode } from "../../../shared/config/config.js";
import type { resolveAgentRoute } from "../../../shared/routing/resolve-route.js";
...
export type LoadedConfig = ReturnType<typeof import("../../../shared/config/config.js").loadConfig>;
...
export type DiscordMessagePreflightContext = {
  ...
  discordConfig: NonNullable<
    import("../../../shared/config/config.js").OpenClawConfig["channels"]
  >["discord"];
  accountId: string;
  token: string;
  runtime: RuntimeEnv;
