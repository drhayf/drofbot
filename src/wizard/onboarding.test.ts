...
import { DEFAULT_BOOTSTRAP_FILENAME } from "../brain/agent-runner/workspace.js";
...
vi.mock("../shared/config/config.js", async (importActual) => {
  const actual = await importActual<typeof import("../shared/config/config.js")>();
  return {
    ...actual,
