...
vi.mock("../brain/agent-runner/model-catalog.js", async () => {
  const actual = await vi.importActual<typeof import("../brain/agent-runner/model-catalog.js")>(
    "../brain/agent-runner/model-catalog.js",
  );
  return {
    ...actual,
